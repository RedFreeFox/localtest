...
function alert(userid){
    document.getElementById("fom").action="../../../user.do?method=updatePwd&Id="+userid;
   document.getElementById("fom").submit();
}
...
<input name="Submit2"type="button" value="返回" class="button" onclick="window.history.go(-1);"/>
			...
			<TD width="100%">
				...
				<legend>修改个人资料</legend>
					  ...
					  <tr>
					    <td nowrap="nowrap" align="right"><span class="red">*</span>原密码:</td>
					    <td colspan="3"><input type="password" class="text" name=user.password0 style="width:154px" value=""/></td>
					    </tr>
					  
					  
					  <tr>
					    <td align="right"><span class="red">*</span>新密码:</td>
					    <td colspan="3"><input type="password" class="text" name=user.password style="width:154px" value=""/></td>
					    </tr>
					  <tr>
					    <td align="right"><span class="red">*</span>重复输入新密码:</td>
					    <td colspan="3"><input type="password" class="text" name=user.password style="width:154px" value=""/></td>
					    </tr>
					  </table>
			  <br />
		...
		<TR>
			...
			<input type="button" name="Submit" value="修改" class="button" onclick="alert(${user.userid });"/>　
		</TD>
		</TR>
		</TABLE>
