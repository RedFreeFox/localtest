...
<body>
<form id="form1" name="form1" action="<%=request.getContextPath()%>/user.do?method=addUser" method="post" onsubmit="return Validator.Validate(this,1)">
              ...
              <tr>
                <td align="center"><table width="272" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="268" align="left"><label>
                      ...
                      <input name="user.name" id="yhm" type="text" dataType="Limit" require="true" msg="用户名不能为空"  />
                    </label></td>
                  </tr>
                  <tr>
                    <td height="25" align="left"><img src="../../user2/images/register_15.gif" width="79" height="17" /></td>
                    <td align="left"><input name="user.password" id="mm" size="25" type="password" dataType="Limit" require="true" msg="密码不能为空"  /></td>
                  </tr>
                  <tr>
                    <td height="25" align="left"><img src="../../user2/images/register_17.gif" width="76" height="19" /></td>
                    <td align="left"><input name="user.password" id="checkmm" size="25" type="password" dataType="Limit" require="true" msg="确认密码不能为空" /></td>
                  </tr>
                </table></td>
                <td width="232" align="right" valign="top"><img src="../../user2/images/register_08.gif" width="232" height="172" /></td>
                    ...
                    <table width="623" height="41" border="0" cellpadding="0" cellspacing="0">
                      <tr align="center">
			<td width="201">&nbsp;</td>
                        <td width="107"><input name="Submit" value="提交"  onclick="onclicks()"  type="image" src="<%=request.getContextPath()%>/page/user2/images/register_22.gif" width="82" height="23" />
					</td>
                        <td width="62"><input onclick="resetform()" type="image" src="<%=request.getContextPath()%>/page/user2/images/rr_24.gif" width="62" height="23"/></td>
			<td width="201">&nbsp;</td>
                      </tr>
                    </table>
          </form>
