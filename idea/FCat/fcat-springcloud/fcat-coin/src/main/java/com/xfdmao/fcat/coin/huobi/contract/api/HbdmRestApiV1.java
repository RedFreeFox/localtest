...
import com.xfdmao.fcat.coin.huobi.contract.util.HbdmHttpClient;
...
public class HbdmRestApiV1 implements IHbdmRestApi {
	...
	public static final String HUOBI_FUTURE_CONTRACT_MATCHRESULTS = "/api/v1/contract_matchresults";
	...
	public String futureContractMatchresults(String symbol, String tradeType, String createDate, String contractCode,
											 String pageIndex, String pageSize) throws HttpException, IOException {
		Map<String, String> params = new HashMap<>();
		if (!StringUtils.isEmpty(symbol)) {
			params.put("symbol", symbol);
		}
		...
		String res = HbdmHttpClient.getInstance().call(api_key, secret_key, "POST",
				url_prex + HUOBI_FUTURE_CONTRACT_MATCHRESULTS, params, new HashMap<>());
		return res;
	}
}
