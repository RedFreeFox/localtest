...
<script>
    $(function () {
        ...
        if(userid==null||userid==undefined||userid==""){
            layer.msg("请先登录", { offset: 0});
        }
        var urlTwo = "${pageContext.request.contextPath}/${userid}/getMessage";
        //alert(urlTwo)
        $.ajax({
            'type' : 'post',
            'url' : urlTwo,
    ...
    function showChat(message){
        ...
        $.getJSON(url,function(data){
            pic = "http://47.107.80.121/" + data.profilehead;
            ...
            var chat = $("#chat-view");
            chat.scrollTop(chat[0].scrollHeight);   //让聊天区始终滚动到最下面
           var urlone = message.from.userid + "/addMessage";
         /*   $.getJSON(urlone,{
                message : html
            },function(data){
                console.log("success")
