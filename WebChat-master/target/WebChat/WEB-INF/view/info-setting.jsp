                ...
                <div class="am-tab-panel am-fade" id="tab2">
                    <center>
                        <div class="up-img-cover"  id="up-img-touch" >
                            <img class="am-circle" alt="点击图片上传" width="140" height="140" src="http://47.107.80.121/${user.profilehead}" data-am-popover="{content: '点击上传', trigger: 'hover focus'}" >
                        </div>
                    </center>
                    ...
                    <%--<form class="am-form am-form-horizontal" action="${ctx}/${userid}/upload" enctype="multipart/form-data" method="post" onsubmit="return checkFileType();" style="text-align: center;">
                        <div style="text-align: center;margin-bottom: 10px">
                            <img class="am-circle" src=/pic/${user.profilehead} width="140" height="140" alt="Amayadream"/>
                        </div>
            ...
            <div class="am-modal-bd  up-frame-body">
                ...
                <div class="am-g am-fl">
                    <div class="up-control-btns">
                        ...
                        <span class="am-icon-check" id="up-btn-ok" url="${ctx}/${userid}/upload"></span>
                    </div>
                </div>
